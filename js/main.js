...
document.addEventListener('DOMContentLoaded', () => {
    function setupEventListeners() {
        ...
        // CORRIGIDO: O listener agora aponta para o ID correto do formulário unificado
        ...
        // CORRIGIDO: O listener de change agora está dentro do setupEventListeners
        document.body.addEventListener('change', e => {
            if (e.target.id === 'tipo-compra') {
                ...
                if (tipo === 'parcelada') {
                    ...
                    selectConta.disabled = true; // Desabilita conta para recorrentes, pois são lançamentos futuros
                }
            }
