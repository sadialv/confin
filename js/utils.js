...
export const CATEGORY_ICONS = {
    'Alimentação': { icon: 'fas fa-utensils', color: '#d946ef' }, 'Transporte': { icon: 'fas fa-car', color: '#3b82f6' },
    ...
    'Contas': { icon: 'fas fa-file-invoice', color: '#64748b' }, 'Compras': { icon: 'fas fa-shopping-bag', color: '#f97316' },
    'Ajustes': { icon: 'fas fa-sliders-h', color: '#78716c' }, 'Pagamento de Fatura': { icon: 'fas fa-receipt', color: '#0ea5e9' },
